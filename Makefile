...
image_macOS:
	docker build --build-arg TARGETOS=darwin --build-arg TARGETARCH=amd64 -t ${REGISTRY}/${APP}:${VERSION}-darwin-amd64 .

image_macOS_arm64:
	docker build --build-arg TARGETOS=darwin --build-arg TARGETARCH=arm64 -t ${REGISTRY}/${APP}:${VERSION}-darwin-arm64 .
